...
export default class IdeaTestimonial extends React.Component {
  render() {
    ...
    const landingName = 'Idea Accelerator Testimonial';
              ...
              <div className="columns is-desktop">
                <div className="column is-8 h-100 bg-header-landing">
                  <div className="view-content-zoom">
                    ...
                    <Title className="title-squeezing">Idea Acelerator in Miami</Title>
                    <Subtitle className="subtitle-squeezing">{siteSubtitle}</Subtitle>
                    <p className="text-description-all">
                      We help early stage and new entrepreneurs transform ideas into{' '}
                      <b>Scalable Software Products</b> through education by using a collaborative
                      and full-companion development process.
                    </p>
                    <Testimonial />
                    <BadgeIndustry />
                  </div>
