                ...
                <Column key={node.fields.slug} isSize="1/3">
                  <Link to={node.fields.slug}>
                    <Card className="card-p">
                      <CardContent className="card-post" style={{backgroundImage: `url(${node.frontmatter.image.publicURL})`}}>
                        <Content className="title-post">
                          <small> <Icon icon={clockO} style={{paddingTop: 5}} /> {node.frontmatter.date}</small>
