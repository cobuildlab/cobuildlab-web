...
import { Container, Section, Title, Hero, HeroBody, HeroHeader,  Columns, Column } from 'bloomer';
import 'bulma';
        ...
        <Wrapper>
          ...
          <Container>
            <StyledSection>
              <Columns>
                <Column>
                <Title isSize={1} hasTextColor="black" className="mb-2">
                  Privacy Policy
                </Title>
                <small>Effective date: September 06, 2018</small>
                <p>
                  Cobuild Lab INC (“us”, “we”, or “our”) operates the https://cobuildlab.com/
                  website and the Cobuild App mobile application (the “Service”).
                </p>
                <p>
                  This page informs you of our policies regarding the collection, use, and
                  disclosure of personal data when you use our Service and the choices you have
                  associated with that data. Our Privacy Policy for Cobuild Lab INC is managed
              ...
              <Columns>
                <Column>
                  ...
                  <Title isSize={2}>Types of Data Collected</Title>
                  <Title isSize={4}>Personal Data</Title>
                  <p>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Use of Data</Title>
                  <p>Cobuild Lab INC uses the collected data for various purposes:</p>
                  <ul>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Transfer Of Data</Title>
                  <p>
                    Your information, including Personal Data, may be transferred to â€” and
                    maintained on â€” computers located outside of your state, province, country or
                  ...
                  <p>
                    Cobuild Lab INC will take all steps reasonably necessary to ensure that your data
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Disclosure Of Data</Title>
                  <Title isSize={2}>Legal Requirements</Title>
                  <p>
                  ...
                  <ul>
                    ...
                    <li>To protect and defend the rights or property of Cobuild Lab INC</li>
                    <li>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Security Of Data</Title>
                  <p>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Service Providers</Title>
                  <p>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Analytics</Title>
                  <p>
                    We may use third-party Service Providers to monitor and analyze the use of our
                    Service.
                  </p>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Links To Other Sites</Title>
                  <p>
                    We may use third-party Service Providers to monitor and analyze the use of our
                    Service.
                  </p>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Children’s Privacy</Title>
              ...
              <Columns>
                <Column>
                  <Title isSize={1}>Contact Us</Title>
