    ...
    <StyledSection2>
      <Container>
        <ServicesSection2
          ...
          text={
            'Web Accessibility means that websites, tools, and technologies must be designed and developed so people with disabilities can use them. When websites are designed and developed with accessibility in mind, all visitors have equal access to site content.\n'
          }
          otherText={
            ...
            <>
              ...
              <p>
                ...
                <p>
                  ...
                  accessibility legislation in most countries around the world.
                </p>
                <p>
                  The WCAG isn{"'"}t a set of laws that can be enforced but many governments have
                  adopted it as the standard for their accessibility laws. Effectively, WCAG
                  compliance is the best means for achieving compliance with most worldwide
                  legislations.
                </p>
              </p>
            </>
