...
export default class AppsDevStudy extends Component {
  render() {
    ...
    const siteDescription = `
      ...
      `;
    const landingName = 'Hire remote developers Monthly';
      ...
      <LandingPageLayout siteDescription={siteDescription} siteTitle={siteTitle}>
        <Columns isDesktop isVCentered>
          <Column isSize={{ desktop: 7 }}>
            ...
            <H4Blue>Senior Developers Teams of 2 or more developers starting at:</H4Blue>
            <br />
            <div className={'has-text-centered'}>
              <H3>
                <TextOrange>$5,999.00 / month</TextOrange>
              </H3>
            </div>
            <br />
            <ul>
